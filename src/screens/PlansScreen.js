    ...
    const loadCheckout = async (priceId) => {
        ...
        docRef.onSnapshot(async(snap) => {
            ...
            if (error) {
                ...
                // Inspect your Cloud Function logs in the firebase
            ...
            if (sessionId) {
                ...
                const stripe = await loadStripe('pk_test_51K1AlZLNYXd4dsKH0RUhRsA04vW2pgPS5uwr09YmkthAgNpRA2zN5ENAGPfWjxml9Sp73boVv4ADkCbg1KxC9s7W009rY6ZWWH')
